...
export async function seedDatabase() {
  try {
    ...
    },
    {
      ...
      description: "Cheil Canada Who are we? Cheil Canada is a full-service agency based out of Mississauga, Ontario ...",
      experience: "Junior",
      jobType: "Full-time",
      location: "Mississauga, ON",
      postedOn: "Indeed",
      skills: ["JavaScript", "Git", "Version control", "Photoshop", "Communication", "Attention to detail"],
    ...
    await AnalyticsModel.create([
      ...
      },
      {
        ...
        chart_type: "radar",
        data: [
          { category: "Programming & Frameworks", mentions: 1319, percentage: 35.7, type: "Hard Skill" },
          ...
          { category: "Communication & Leadership", mentions: 606, percentage: 16.4, type: "Soft Skill" },
          { category: "Problem Solving & Teamwork", mentions: 499, percentage: 13.5, type: "Soft Skill" }
        ],
        domain: "Web",
        metadata: {
          total_categories: 6,
      ...
      },
      {
        ...
        chart_type: "radar",
        data: [
          { category: "Programming & Frameworks", mentions: 460, percentage: 15.6, type: "Hard Skill" },
          ...
          { category: "Communication & Leadership", mentions: 399, percentage: 13.5, type: "Soft Skill" },
          { category: "Problem Solving & Teamwork", mentions: 530, percentage: 18, type: "Soft Skill" }
        ],
        domain: "DevOps",
        metadata: {
          total_categories: 6,
