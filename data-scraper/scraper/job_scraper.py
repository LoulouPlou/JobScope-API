...
def append_new_jobs_to_master(new_jobs, output_dir="data-scraper/data"):
    os.makedirs(output_dir, exist_ok=True)
...
def run_analysis():
    """Run buzzword and experience analysis - returns statistics."""
    print("\nAnalyzing jobs...")
    ...
    total_mentions = sum(r["total_buzzwords"] for r in analysis_results)
